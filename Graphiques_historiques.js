...
// GRAPHIQUES MENSUELLES
  ...
  // Création du graphique synthétique des températures mensuelles
      ...
      var url = "https://cors.io/?https://github.com/damiendecelle/Data_Kermap_ApplicationMeteo/blob/main/Auckland_journaliere.csv" + queryLoc + "_mensuelle.csv"
  ...
  // Création du graphique synthétique des températures mensuelles
      ...
      function fetchCity1() {
      var queryLoc = document.getElementById("queryLoc").value;
      var url1 = "https://cors.io/?https://github.com/damiendecelle/Data_Kermap_ApplicationMeteo/blob/main/" + queryLoc + "_mensuelle.csv"
  ...
  // Création du graphique synthétique des ecarts de températures mensuelles
      ...
      function fetchCity2() {
      var queryLoc = document.getElementById("queryLoc").value;
      var url2 = "https://cors.io/?https://github.com/damiendecelle/Data_Kermap_ApplicationMeteo/blob/main/" + queryLoc + "_mensuelle.csv"
  ...
  // Création du graphique synthétique des ecarts de précipitations mensuelles
      ...
      function fetchCity3() {
      var queryLoc = document.getElementById("queryLoc").value;
      var url3 = "https://cors.io/?https://github.com/damiendecelle/Data_Kermap_ApplicationMeteo/blob/main/" + queryLoc + "_mensuelle.csv"
  ...
  // Création du Diagramme ombrothermique des normales de saison
      ...
      function fetchCity4() {
      var queryLoc = document.getElementById("queryLoc").value;
      var url4 = "https://cors.io/?https://github.com/damiendecelle/Data_Kermap_ApplicationMeteo/blob/main/" + queryLoc + "_mensuelle.csv"
  ...
  // Création du Diagramme ombrothermique des normales de saison
      ...
      function fetchCity5() {
      var queryLoc = document.getElementById("queryLoc").value;
      var url5 = "https://cors.io/?https://github.com/damiendecelle/Data_Kermap_ApplicationMeteo/blob/main/" + queryLoc + "_mensuelle.csv"
...
// GRAPHIQUES JOURNALIERS
      ...
      function fetchCity6() {
      var queryLoc = document.getElementById("queryLoc").value;
      var url6 = "https://cors.io/?https://github.com/damiendecelle/Data_Kermap_ApplicationMeteo/blob/main/" + queryLoc + "_journaliere.csv"
  ...
  // Création du graphique synthétique des précipitations journalières
      ...
      function fetchCity7() {
      var queryLoc = document.getElementById("queryLoc").value;
      var url7 = "https://cors.io/?https://github.com/damiendecelle/Data_Kermap_ApplicationMeteo/blob/main/" + queryLoc + "_journaliere.csv"
  ...
  // Création du graphique synthétique des écarts de températures journalières
      ...
      function fetchCity8() {
      var queryLoc = document.getElementById("queryLoc").value;
      var url8 = "https://cors.io/?https://github.com/damiendecelle/Data_Kermap_ApplicationMeteo/blob/main/" + queryLoc + "_journaliere.csv"
